          ...
          {!user && (
            <div className="space-y-3">
              ...
              <button
                ...
                onClick={handleGoogleSignIn}
                disabled={authLoading || submitting}
                className="w-full py-3 bg-[#181818] border border-white/10 hover:bg-white/[0.04] disabled:opacity-50 text-white font-semibold text-xs rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-all"
              >
          ...
          {user && (
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <span className="text-[9px] text-gray-500 uppercase tracking-wider font-bold">Display Name</span>
                <input
                  type="text"
                  placeholder="Display name"
                  value={displayName}
                  onChange={(e) => setDisplayName(e.target.value)}
                  required
                  className="w-full bg-[#161616] border border-white/10 rounded-xl text-xs p-3.5 text-white outline-none focus:border-white/30 transition-all"
                />
              </div>
              <div className="space-y-1.5">
                <span className="text-[9px] text-gray-500 uppercase tracking-wider font-bold">Username</span>
                <input
                  type="text"
                  placeholder="Username"
                  value={username}
