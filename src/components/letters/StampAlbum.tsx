...
export const StampAlbum: React.FC = () => {
  ...
  return (
    <div className="bg-[#FAFAF7] py-8 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-[#E5E7EB] p-6 shadow-sm mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <h1 className="text-3xl font-[family-name:var(--font-letters-serif)] text-[#13294B] font-bold">Stamp Album</h1>
              <p className="text-[#13294B]/60 text-sm mt-1">Every letter tells a story, and every stamp marks a journey.</p>
            </div>
            <div className="w-full md:w-64 text-right space-y-2">
              <div className="flex justify-between text-sm font-semibold text-[#13294B]">
                <span>Album Progress</span>
                <span>{unlockedCount} / {totalStamps} ({completionPercentage}%)</span>
              </div>
              <div className="w-full h-3 bg-[#E8E6E1] rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#F4B400] transition-all duration-500 rounded-full"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <input
            ...
            className="flex-1 px-4 py-2 rounded-full border border-[#E5E7EB] bg-white focus:outline-none focus:ring-2 focus:ring-[#F4B400] text-sm"
          />
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-bold border transition ${
                  rarityFilter === rarity
                    ...
                    : 'bg-white border-[#E5E7EB] text-[#13294B] hover:bg-[#E8E6E1]'
                }`}
              >
                {rarity}
              </button>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {filteredStamps.map((stamp) => (
            <div
              ...
              className={`cursor-pointer group aspect-square bg-white border-2 rounded-xl flex flex-col items-center justify-center p-3 transition relative ${
                stamp.unlocked
                  ? 'border-[#E5E7EB] shadow-sm hover:shadow-md hover:-translate-y-1'
            ...
            >
              ...
              <span className="text-xs font-semibold text-[#13294B] text-center leading-tight truncate w-full">
                {stamp.name}
              </span>
        ...
        {selectedStamp && (
          <div className="fixed inset-0 bg-[#13294B]/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white border border-[#E5E7EB] max-w-md w-full rounded-2xl p-6 shadow-2xl relative">
              <button
                onClick={() => setSelectedStamp(null)}
                className="absolute top-4 right-4 text-[#13294B]/60 hover:text-[#13294B] text-xl font-bold"
              >
                ✕
              </button>

              <div className="flex flex-col items-center text-center mt-2">
                <div className="text-6xl mb-4 bg-[#FAFAF7] w-20 h-20 rounded-full flex items-center justify-center border border-[#E5E7EB]">
                  {selectedStamp.image}
                </div>
                <h3 className="text-2xl font-[family-name:var(--font-letters-serif)] font-bold text-[#13294B]">{selectedStamp.name}</h3>
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-0.5 bg-[#E8E6E1] text-[#13294B] text-[10px] uppercase font-bold rounded">
                ...
                <p className="text-[#13294B]/80 text-sm mt-4 italic font-[family-name:var(--font-letters-serif)] px-2">
                  "{selectedStamp.description}"
                </p>

                <div className="w-full mt-6 bg-[#FAFAF7] rounded-xl p-4 border border-[#E5E7EB] text-left">
                  <span className="text-xs uppercase text-[#13294B]/50 tracking-wider font-bold block mb-1">
                    How to unlock
                  </span>
                  <p className="text-sm text-[#13294B] font-medium">
                    {selectedStamp.unlockCondition}
                  </p>

                  {selectedStamp.unlocked && (
                    <div className="mt-3 border-t border-[#E8E6E1] pt-2 flex justify-between text-xs text-[#13294B]/70">
