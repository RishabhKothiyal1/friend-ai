...
export const LetterReader: React.FC<LetterReaderProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] dark:bg-gray-950 flex flex-col p-4 relative">
      {step < 3 && (
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          >
            ...
            <div className="w-[320px] h-[220px] md:w-[480px] md:h-[320px] bg-[#dfd6c5] rounded-2xl shadow-xl relative flex items-center justify-center border border-[#E5E7EB] dark:border-gray-800">
              ...
              {/* Back Flap (top) */}
              <div
                className="absolute top-0 left-0 right-0 h-[160px] bg-[#c3b69f] origin-top rounded-t-2xl z-20 border-b border-[#13294B]/5"
                style={{
              ...
              {step === 0 && (
                <div
                  className="absolute z-30 w-14 h-14 md:w-16 md:h-16 rounded-full bg-red-800 shadow-lg flex items-center justify-center text-white border-2 border-yellow-600/30"
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              {onReply && (
                <button
                  ...
                  className="flex-1 sm:flex-initial px-6 py-2 bg-[#13294B] text-white rounded-full hover:bg-[#13294B]/95 transition text-xs font-bold shadow-sm"
                >
                  Reply
                </button>
              )}
