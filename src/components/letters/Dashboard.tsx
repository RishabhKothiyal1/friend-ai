        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-900 border border-[#E5E7EB] dark:border-gray-800 rounded-2xl p-5 shadow-sm flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#F4B400]/15 dark:bg-amber-500/15 flex items-center justify-center text-lg">
                📭
              </div>
              <div>
                <h4 className="font-bold text-sm text-[#13294B] dark:text-gray-100">No incoming deliveries</h4>
                <p className="text-[#13294B]/60 dark:text-gray-400 text-xs mt-0.5">Letters will appear here once someone sends you one.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-[#E5E7EB] dark:border-gray-800 rounded-2xl p-5 shadow-sm flex items-center justify-between hover:bg-[#E8E6E1]/30 dark:hover:bg-gray-800 transition cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#13294B]/60 dark:text-gray-400 text-xs">Check your Stamp Album</p>
              </div>
            </div>
            <span className="text-[#13294B]/40 dark:text-gray-500 text-lg">➔</span>
          </div>
